<?php
// film_add.php - Dodavanje novog filma (samo prijavljeni korisnici)
...
$film = [
    'naslov' => '', 'zanr' => '', 'godina' => '', 
    'trajanje' => '', 'ocjena' => '', 'reziser' => '', 'zemlja' => ''
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($film['naslov'])) {
        ...
        $greska = 'Trajanje mora biti broj (u minutama).';
        ...
        $stmt->execute([
            ...
            $film['reziser'], $film['zemlja']
        ]);
        $uspjeh = 'Film "' . $film['naslov'] . '" uspješno dodan!';
        $film = ['naslov'=>'','zanr'=>'','godina'=>'','trajanje'=>'','ocjena'=>'','reziser'=>'','zemlja'=>''];
    }
}

$pageTitle = 'Dodaj film';
...
<div class="form-container" style="max-width:600px;">
    ...
    <form method="POST" action="film_add.php">
        ...
        <div class="form-group">
            ...
            <input type="text" id="zanr" name="zanr" value="<?= htmlspecialchars($film['zanr']) ?>" required placeholder="npr. Action, Drama">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" id="zemlja" name="zemlja" value="<?= htmlspecialchars($film['zemlja']) ?>" required placeholder="npr. USA, UK/USA">
        </div>
